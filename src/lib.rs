...
pub mod pallet {
	...
	#[pallet::storage]
	pub(super) type CountForKitties<T: Config> =
		StorageValue<Value = u32, QueryKind = ValueQuery, OnEmpty = GetDefault>;
	...
	pub enum Event<T: Config> {
		...
		PriceSet { owner: T::AccountId, new_price: Option<BalanceOf<T>>, kitty_id: [u8; 32] },
	}
